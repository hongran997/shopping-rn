...
const login = () => {
  ...
  // Form hook
  const { handleSubmit, formState: { errors: formErrors }, setFocus, control } =
    useForm({ resolver: yupResolver(logInSchema), defaultValues: { email: '', password: '' } })
  ...
  return (
    <>
      ...
      <View style={tw`w-full h-full bg-white pt-10 px-8`}>
        ...
        <TextField errors={formErrors.password} control={control} placeholder='请输入您的账户密码' name='password' secureTextEntry style='mb-1'></TextField>
